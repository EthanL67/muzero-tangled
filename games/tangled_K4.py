...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 4, 5)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = list(range(3*6+4))  # Fixed list of all possible actions. You should only edit the length
        ...
        self.num_unroll_steps = 9  # Number of game moves to keep for every batch element
